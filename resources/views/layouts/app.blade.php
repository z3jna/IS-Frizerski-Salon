        ...
        <div class="collapse navbar-collapse" id="nav">
            @auth
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link" href="{{ route('home') }}">Pocetna</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('racuni.index') }}">Racuni</a></li>
                    ...
                    @if(auth()->user()->isAdmin())
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ route('izvestaji.index') }}">Izvestaji</a></li>
                    @endif
                </ul>
            ...
            @else
                <ul class="navbar-nav ms-auto align-items-xl-center">
                    ...
                    <li class="nav-item"><a class="btn btn-sm btn-light ms-lg-2" href="{{ route('register') }}">Registracija</a></li>
                </ul>
            @endauth
        </div>
    </div>
