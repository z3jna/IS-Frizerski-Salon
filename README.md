...
Angular se koristi za prijavu, registraciju i zakazivanje u okviru istog Laravel projekta. Vite lokalno servira samo razvojne assete:
...
http://127.0.0.1:8000/termini/create
```

Laravel i Angular koriste isti host i isti port. Na produkciji iste relativne rute automatski koriste aktivni hostovani domen.
...
Angular login, registracija i zakazivanje serviraju se preko istog `APP_URL` domena kao i Laravel stranice. Poseban Angular domen nije potreban.
